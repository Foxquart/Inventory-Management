...
Live demo: https://inventory.foxquart.com/
...
```
public/                Favicons, touch icons, and site.webmanifest (see Branding)
src/
  ...
  data/
    catalog.js         Categories, suppliers, bike models, and the 36 seeded parts
...
This is a demo build by [Foxquart](https://foxquart.com). The icon files in `public/`
(favicon.ico, favicon-*.png, apple-touch-icon.png, android-chrome-*.png) are the Foxquart
favicon set, wired through the `icons` and `manifest` fields in `src/app/layout.jsx`.
